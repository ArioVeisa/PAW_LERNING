...
<head>
    ...
    <meta name="description"
        content="Halaman praktikum modul 8 mata kuliah pemrograman web di program studi sistem informasi">
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="student_name" value="<?= $student_name ?>" size="20"
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="radio" name="student_gender" value="man" id="pria"
                                <?php echo $checked_man  ?>><label for="pria">Pria</label>
                            <input type="radio" name="student_gender" value="woman" id="wanita"
                                <?php echo $checked_woman  ?>><label for="wanita">Wanita</label>
                        </td>
                    </tr>
                    <tr>
                        <td>Upload Foto*</td>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="student_password_confirmation"
                                value="<?= $student_password_confirmation ?>" size="20" placeholder="Password Anda">
                        </td>
                    </tr>
                </table>
            </fieldset>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="student_skill_html" value="html" id="html"
                                <?= $student_skill_html ?>><label for="html">HTML</label>
                            <input type="checkbox" name="student_skill_css" value="css" id="css"
                                <?= $student_skill_css ?>><label for="css">CSS</label>
                            ...
                            <input type="checkbox" name="student_skill_php" value="php" id="php"
                                <?= $student_skill_php ?>><label for="php">PHP</label>
                            ...
                            <input type="checkbox" name="student_skill_react_native" value="react_native"
                                id="react_native" <?= $student_skill_react_native ?>><label for="react_native">React
                                Native</label>
                        </td>
                    </tr>
                </table>
